      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4 animate__animated animate__fadeInUp animate__delay-500ms">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Upcomming events</h6>
                </div>
                <div class="card-body">
                  <h4 class="small font-weight-bold">singing compition</h4>
                  <div class="text-right">
                    <button type="button" class="btn btn-primary btn-sm">Registration</button>
                  </div>
                  <div style="margin-top: 5px;">
                    <hr class="sidebar-divider my-0">
                  </div>
                  <h4 class="small font-weight-bold" style="margin-top: 5px;">Sales Tracking</h4>
                  <div class="text-right">
                    <button type="button" class="btn btn-primary btn-sm">Registration</button>
                  </div>
                  <div style="margin-top: 5px;">
                  ...
                  <h4 class="small font-weight-bold" style="margin-top: 5px;">Customer Database</h4>
                  <div class="text-right">
                    <button type="button" class="btn btn-primary btn-sm">Registration</button>
                  </div>
                  <div style="margin-top: 5px;">
                  ...
                  <h4 class="small font-weight-bold" style="margin-top: 5px;">Payout Details</h4>
                  <div class="text-right">
                    <button type="button" class="btn btn-primary btn-sm">Registration</button>
                  </div>
                  <div style="margin-top: 5px;">
                  ...
                  <h4 class="small font-weight-bold" style="margin-top: 5px;">Account Setup</h4>
                  <div class="text-right">
                    <button type="button" class="btn btn-primary btn-sm">Registration</button>
                  </div>
                </div>
            ...
            <div class="card shadow mb-4 animate__animated animate__fadeInUp animate__delay-500ms">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Important Notice</h6>
              </div>
              <div class="card-body">
                <p>No Important --Notice</p>
                <a href="notice.jsp">Browse Notice Board</a>
              </div>
            </div>
            </div>
