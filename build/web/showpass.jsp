				...
				<span class="login100-form-title p-b-37">
					Your Password
                                ...
                                <div class="wrap-input100 m-b-20">
                                    <input class="input100 disabled" type="text" name="mobno" value="Science1221">
				</div>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter Your Mobile Number">
                                    <input class="input100" type="text" name="mobno" placeholder="Enter Your Mobile Number for send sms" maxlength="10">
					<span class="focus-input100"></span>
				</div>

				<div class="container-login100-form-btn">
                                    <a class="login100-form-btn" href="login.jsp" style="text-decoration: none;">
						Send
					</a>
				</div>
