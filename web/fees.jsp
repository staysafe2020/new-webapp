<%-- 
    Document   : fees
    Created on : 25 Mar, 2020, 5:35:52 PM
    Author     : arpit
--%>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Fees</a>
                  ...
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-4 pr-1">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Firstname" disabled>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 pl-1">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Lastname" disabled>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 pr-1">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Roll Number" disabled>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <label class="custom-control-label" for="defaultInline1">Online</label>
                      </div>
                      </div>
                    ...
                    <div class="text-left" style="margin-top: 20px;">
                      <a href="#" class=" btn btn-sm btn-primary shadow-sm"><i
                        class="fas fa-download fa-sm text-white-50"></i> Generate Reciept</a>
                    </div>
